<!-- Ganti codenya dengan yang dibuku semuanya -->
                    ...
                    <div class="card-body">
                        <form action="{{ route('mhs.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('jurusan') is-invalid @enderror" name="jurusan" value="{{ old('jurusan') }}" placeholder="Masukkan nama jurusan">
